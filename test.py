...
from create_training_data import randomly_generate_testing_data

input_shape = (160, 160, 1)  # Grayscale image of size 160 * 160
model = build_cnn_reconstructor(input_shape)
...
# 單一圖片路徑
fingerprint_path = "./DB4_B/101_1.tif"
...
# 處理圖片
processed_image = process_single_image(fingerprint_path, output_size)
